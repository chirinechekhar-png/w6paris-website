...
const PRODUCTS = [
  {
    ...
    desc: {
      fr: "Conçu pour les intérieurs d'exception, le Diffuseur i6 associe une technologie de nébulisation de précision à un pilotage direct depuis votre téléphone, pour une atmosphère à votre image. Nos huiles, formulées à Grasse, berceau du parfum, et conformes aux normes IFRA, se révèlent ici dans toute leur pureté.",
      en: "Designed for exceptional interiors, the Diffuser i6 pairs precision cold-nebulization technology with direct phone control to shape an atmosphere that reflects you. Our oils, composed in Grasse — the cradle of perfumery — and compliant with IFRA standards, are revealed here in all their purity."
    },
    features: [
      ...
      { fr: "Connexion directe au téléphone (Bluetooth)", en: "Direct phone connection (Bluetooth)" }
    ],
    options: [
      {
        key: "color",
  ...
  },
  {
    ...
    desc: {
      fr: "Le Diffuseur i7 est un système de diffusion haut de gamme, sans chaleur, pensé pour les espaces les plus raffinés. Sa technologie brevetée de diffusion à froid et son pilotage direct sur smartphone dispersent avec finesse nos huiles parfumées, formulées à Grasse, pour une expérience sensorielle d'exception, sans jamais en altérer la richesse. Maison, hôtel ou espace professionnel : le Diffuseur i7 façonne une identité olfactive unique, à la mesure de chaque lieu.",
      en: "The Diffuser i7 is a high-end, heat-free diffusion system designed for the most refined spaces. Its patented cold-diffusion technology and direct smartphone control finely disperse our fragrance oils, composed in Grasse, for an exceptional sensory experience — never altering their richness. Home, hotel or professional space: the Diffuser i7 shapes a unique olfactory identity, in keeping with every place."
    },
    features: [
